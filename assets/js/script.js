$(document).ready(function () {
    ...
    $("#contact-form").submit(function (event) {
        ...
        const mailtoLink = `mailto:praneeth.janjanam@gmail.com?subject=Contact Form Submission from ${name}&body=Name: ${name}%0D%0AEmail: ${email}%0D%0APhone: ${phone}%0D%0AMessage:%0D%0A${message}`;
